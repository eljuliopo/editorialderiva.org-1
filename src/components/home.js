    ...
    <Grid stackable columns='equal' style={{
      ...
      EDICIÓN & MANUFACTURA DE LIBROS
        ...
        <Container text fluid>
          ...
          <Divider />
          Las ideas humanas son una construcción histórica y social imposibles de apropiar, por ello, ante la propiedad intelectual promovemos intelecto contra la propiedad.
          <Divider />
          </p>
          </b>
